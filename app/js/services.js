...
myService.factory('Friend',['$resource',function($resource){
	return $resource('friends/friends.json');
}]);
myService.factory('Life',['$resource',function($resource){
	return $resource('friends/life.json');
}]);

var ngWaterfall = angular.module('ngWaterfall',[])
            ...
            return {
                ...
                link: function(scope,element){
                    ...
                    $rootScope.$on("waterfall:repeatFinished",function(){
                        ...
                        $('.turnToNextPage').css('display','block');
                    });
